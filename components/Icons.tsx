...
// FIX: Updated to accept standard SVG props.
export const LogoIcon = (props: React.ComponentProps<'svg'>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M17.5 9.5a2 2 0 1 0-4 0 2 2 0 0 0 4 0z"/>
    <path d="M14 11.5l-2.5 2-3.5-1.5-2 4h12l-2-6-2-2.5z"/>
    <path d="M15 6c1.5-1.5 3.5-1.5 5 0"/>
    <path d="M15 3c1.5-1.5 3.5-1.5 5 0"/>
    <path d="M6.13 14.63c-3.8-1.5-3.8-5.77 0-7.27l.1-.04c1.32-.53 2.76-.2 3.77.83"/>
  </svg>
);
...
// FIX: Updated to accept standard SVG props.
export const CoffeeIcon = (props: React.ComponentProps<'svg'>) => (
...
export const FlameIcon = (props: React.ComponentProps<'svg'>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5-2 4.5-2 4.5-.5 1.5-1.5 2.5-1.5 2.5-1 2 .5 3.5 1.5 3.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5-2 4.5-2 4.5-.5 1.5-1.5 2.5-1.5 2.5-1 2 .5 3.5 1.5 3.5A2.5 2.5 0 0 0 11 12"/></svg>
);
...
// FIX: Updated to accept standard SVG props.
export const ChartIcon = (props: React.ComponentProps<'svg'>) => (
...
// FIX: Updated to accept standard SVG props.
export const BotIcon = (props: React.ComponentProps<'svg'>) => (
...
// FIX: Updated to accept standard SVG props.
export const BrainCircuitIcon = (props: React.ComponentProps<'svg'>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5a3 3 0 1 0-5.993.129"/><path d="M12 5a3 3 0 1 0 5.993.129"/><path d="M12 19a3 3 0 1 0-5.993-.129"/><path d="M12 19a3 3 0 1 0 5.993.129"/><path d="M21 12a3 3 0 1 0-.129-5.993"/><path d="M3 12a3 3 0 1 0 .129-5.993"/><path d="M21 12a3 3 0 1 0-.129 5.993"/><path d="M3 12a3 3 0 1 0 .129 5.993"/><path d="M12 5v14"/><path d="M19 12H5"/></svg>
);

// FIX: Updated to accept standard SVG props.
export const LeafIcon = (props: React.ComponentProps<'svg'>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 20A7 7 0 0 1 4 13V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2.34c0 1.54.84 2.92 2.17 3.66"/><path d="M11 20v-4.66a2.34 2.34 0 0 1 1-1.99l2.83-1.62a2 2 0 0 1 2.17 3.66L14 18a2 2 0 0 1-2 2Z"/></svg>
);

// FIX: Updated to accept standard SVG props.
export const WaterDropIcon = (props: React.ComponentProps<'svg'>) => (
...
// FIX: Updated to accept standard SVG props.
export const RotateCwIcon = (props: React.ComponentProps<'svg'>) => (
...
// FIX: Updated to accept standard SVG props.
export const FileTextIcon = (props: React.ComponentProps<'svg'>) => (
...
export const SparklesIcon = (props: React.ComponentProps<'svg'>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m12 3-1.45 4.1-4.1 1.45 4.1 1.45 1.45 4.1 1.45-4.1 4.1-1.45-4.1-1.45z"/><path d="M12 3L9.5 8.5 4 11l5.5 2.5L12 19l2.5-5.5L20 11l-5.5-2.5z"/></svg>
);

// FIX: Updated to accept standard SVG props.
export const ScaleIcon = (props: React.ComponentProps<'svg'>) => (
